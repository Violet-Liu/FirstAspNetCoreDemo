...
var BucktInit=function(){
    ...
    bInit.Init = function () {
        $("#btn_submit_bucket").click(function () {
            //var validator2 = $("#bucketform").data('bootstrapValidator');
            ////手动触发验证
            //validator2.validate();
        ...
        //$("#bucketModal").on('hidden.bs.modal', function () {
        //    $("#bucketform").data('bootstrapValidator').destroy();
        //    $('#bucketform').data('bootstrapValidator', null);
        //});
    };

    ////绑定验证
    //bInit.formValidator = function () {
    //    $("#bucketform").bootstrapValidator({
    //        message: 'This value is not valid',
    //        feedbackIcons: {
    //            valid: 'glyphicon glyphicon-ok',
    //            invalid: 'glyphicon glyphicon-remove',
